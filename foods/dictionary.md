...
Personal food database. Every food that appears in the log has a row here.
All nutrient values are **per 100 g** (ml for liquids); the portion column is
this user's usual serving. Source: `label` (see `foods/labels/`) or
`estimate` (generic USDA-typical values). **Key micros** lists the tags from
`foods/micronutrients.md` that a usual portion meaningfully provides.

`Sugar` is total sugar; `Added` is the free-sugar part only (added in
production or preparation, plus honey, syrups and fruit juice). Sugar
naturally present in whole fruit, vegetables and milk is not counted as
added.
...
| Suc de mere (Ana Are, 100% fruct) | 52 | 0.01 | 12.7 | 0.1 | 0 | 11.7 | 11.7 | 250 ml (1 pahar) | — | [label](labels/ana-are-suc-mere.md) |
...
| Pear (pară) | 57 | 0.4 | 15.2 | 0.1 | 3.1 | 9.8 | 0 | 130 g (1 mică) | — | estimate |
...
| Chicken, roasted, no skin (meat off a leg quarter) | 190 | 28 | 0 | 7.5 | 0 | 0 | 0 | 180 g | b12, zn | estimate |
...
| Grisine (cofetărie) | 440 | 10 | 68 | 12 | 2.5 | 1.5 | 0 | 30 g (~5-6 buc) | — | estimate |
...
| Hrișcă înăbușită cu roșii și morcov | 100 | 3.5 | 20 | 1.5 | 3.0 | 2.5 | 0 | 220 g (porție) | vitC, k | estimate |
| Piept de pui cu legume la tigaie, fără ulei (dovlecel, morcov, roșii cherry) | 90 | 12 | 6.0 | 1.5 | 1.5 | 3.0 | 0 | 200 g (porție) | vitC, k, b12, zn | estimate |
...
| Ficăței de pui, la tigaie (simpli) | 165 | 24 | 1.0 | 6.0 | 0 | 0 | 0 | 160 g (porție) | iron, b12, zn | estimate |
| Orez cu morcov și ardei (pilaf) | 150 | 3.0 | 26 | 3.5 | 1.0 | 2.0 | 0 | 220 g (porție) | vitC, k | estimate |
...
| Mâncare de năut cu piept de pui (cartof, dovlecel, roșii, ulei de măsline) | 117 | 9.0 | 9.4 | 4.8 | 2.2 | 1.4 | 0 | 425 g (1 porție) | iron, b12, zn, k | estimate |
...
| Tort de copii, cremă, puțin/fără zahăr adăugat (homemade) | 280 | 5.0 | 30 | 15 | 1.0 | 8.0 | 3.0 | 40 g (bucată mică) | — | estimate |
